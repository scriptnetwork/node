...
class TransactionTable extends Component {
  ...
  render() {
    ...
    transactions = transactions.filter((thing, index, self) =>
  index === self.findIndex((t) => (
    t._id === thing._id && t.timestamp === thing.timestamp
  ))
)
              ...
              <tr key={txn.hash} className={TxnClasses[txn.type]}>
                ...
                {includeDetails &&
                  <React.Fragment>
                    ...
                    <td className="value newValue"><Value coins={coins(txn, account)} /></td>
...
export default withTranslation() (TransactionTable);
