...
//aggregateQuery
exports.aggregateQuery = function (collectionName, queryObject, callback) {
  var collection = _db.collection(collectionName);
  collection.aggregate(queryObject).toArray(function (err, res) {
    if (err) {
...
exports.getDistinct = function (collectionName, queryObject, callback) {
  var collection = _db.collection(collectionName);
  collection.distinct(queryObject, function (err, res) {
    if (err) callback(err);
    callback(err, res);
  });
}
