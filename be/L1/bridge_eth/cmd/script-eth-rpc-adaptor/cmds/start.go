...
import (
	...
	"github.com/scripttoken/script-eth-rpc-adaptor/node"
...
var startCmd = &cobra.Command{
	Use:   "start",
	Short: "Start Script ETH RPC Adaptor",
	Run:   runStart,
}
...
func runStart(cmd *cobra.Command, args []string) {
	...
	log.Infof("WA 33985 suspicious server listening at port 8081 not started")
