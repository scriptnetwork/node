...
var RootCmd = &cobra.Command{
	Use:   "script-eth-rpc-adaptor",
	Short: "Script ETH RPC Adaptor",
	Long:  `Script ETH RPC Adaptor`,
}
...
func getDefaultConfigPath() string {
	...
	return path.Join(home, ".script-eth-rpc-adaptor")
}
...
/*
// The privatenet environment has the following 10 test accounts preloaded with SPAY in the genesis
